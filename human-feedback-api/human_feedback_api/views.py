...
def user_login(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            try:
                # print("\tLAUNCHING THE SPORTS COMMAND")
                # # Command for the sports domain
                # sports_process = subprocess.Popen(
                #     [
                ...
                # print("\tLAUNCHING THE TRIPS COMMAND")
                # Command for the sports domain
                ...
                # print("\tLAUNCHING THE COURSES COMMAND")

                # Command for the courses domain
...
def _build_experiment_resource(experiment_name):
    ...
    try:
        ...
        pretty_time_elapsed = _pretty_time_elapsed(started_at, now_naive)
